...
headless_probe() {
  ...
  for name in ui_init input_reset ui_command_palette ui_modal_run TRAPWINCH main_tui handle_slash_command zdraw-list zdraw-layout-center zdraw-help ui_document_view zdraw-document; do
