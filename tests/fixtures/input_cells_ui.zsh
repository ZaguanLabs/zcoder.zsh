...
zcoder_curses addwin input_win 6 10 0 0 || exit 1
INPUT_BUF='界界界'; INPUT_POS=3
_ui_paint_input 1
zcoder_curses refresh input_win
local -a cursor=() first=() second=()
zcoder_curses position input_win cursor
zcoder_curses move input_win 1 4; zcoder_curses querychar input_win first
zcoder_curses move input_win 2 4; zcoder_curses querychar input_win second
