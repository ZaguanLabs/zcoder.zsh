...
source "${EVAL_PROJECT_DIR}/lib/command_safety.zsh"
source "${EVAL_PROJECT_DIR}/lib/tools.zsh"
source "${EVAL_PROJECT_DIR}/lib/compact.zsh"
source "${EVAL_PROJECT_DIR}/lib/agent.zsh"
source "${EVAL_PROJECT_DIR}/lib/agent_prompts.zsh"
source "${EVAL_PROJECT_DIR}/lib/agent_lfm.zsh"
source "${EVAL_PROJECT_DIR}/lib/agent_loop.zsh"
